...
//             </span>
//           </div>
//           <p className="text-[16px] mt-[20px] text-center md:text-start md:mt-0 tracking-[0.36px] font-sans text-[#D9D9D9] font-regular w-full max-w-[517px] text-wrap">
...
//         <div>
//         <img src={HeroImg} className="h-auto w-full max-w-[430px] md:max-w-[650px]" alt="" />
//         </div>
