...
//   return (
//     <div className="w-full flex flex-col gap-16 items-center py-3" ref={sectionRef}>
//       <div className="flex flex-col gap-[10px] items-center justify-start">
//         <div className="text-[16px] font-normal font-sans text-HeadingBlue">
//           PRICING
//         </div>
...
//           className="flex flex-col items-start p-8 hover:scale-105 bg-pricingSection rounded-lg w-full max-w-[360px] transition-all duration-300 hover:bg-pricingPro hover:text-white group"
//         >
//           <div className="bg-customBlue text-white font-sans text-[14px] rounded-[8px] font-medium px-4 py-[6px] mb-4">
//             BASIC
//           </div>
...
//           className="flex flex-col items-start hover:scale-105 p-8 bg-pricingSection rounded-lg w-full max-w-[360px] transition-all duration-300 hover:bg-pricingPro hover:text-white group"
//         >
//           <div className="bg-customBlue text-white font-medium px-4 py-[6px] rounded-[8px] mb-4">
//             PRO
//           </div>
